...
export default function ViewCar() {
  return (
    <div className="grid grid-cols-1 lg:grid-cols-2 lg:gap-10 lg:items-center mx-4">
      {/* Left container */}
      <div>
        {/* Large Image */}
        <div>
        ...
        <div className="mt-10">
          ...
          <div className="grid grid-cols-2 gap-5 py-7">
            <div className="flex justify-center gap-1 items-center px-2 py-1 border-2 rounded-3xl">
              ...
              <div>
                <p className="text-gray-500">4700</p>
              </div>
            </div>
            <div className="flex justify-center gap-1 items-center px-2 py-1 border-2 rounded-3xl">
        ...
        <p className="text-gray-500 text-lg">
          ...
          fugiatniam, quis nostrud exercitation ullamco laboris nisi ut aliquip
      ...
      <div>
        <div className="flex flex-col mt-10 border-2 p-6 rounded-xl">
          <p className="font-semibold text-gray-500 text-xl pb-8">
            ZAR <span className="text-black font-bold text-3xl">500 000</span>
          </p>
          <p className="font-semibold text-2xl py-5">
            Interested in Buying This Car?
          </p>
          <div>
            <button className="text-white bg-blue-500 font-semibold px-8 py-3 rounded">
              SUBMIT AN ENQUIRY
            </button>
          </div>
